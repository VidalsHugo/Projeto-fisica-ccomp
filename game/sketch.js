...
function preload() {
  personImg = loadImage('person.png'); // Substitua pelo caminho correto da imagem do personagem
  bgImg = loadImage('sala2.png'); // Substitua pelo caminho correto da imagem do fundo
  carpetImg = loadImage('carpet.png'); // Substitua pelo caminho correto da imagem do tapete
  cenarioImg = loadImage('cenario.png'); // Imagem de fundo para o menu inicial
  playImg = loadImage('play.png'); // Imagem do botão "Play"
  backgroundMusic = loadSound('music.mp3'); // Música de fundo
  shockSound = loadSound('shock.mp3'); // Som do choque
}
